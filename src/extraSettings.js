...
// 第一个水果：修改数字为 0-10, 0 为葡萄，9 为半个卷王
let firstFruit = 0;
...
const minRandomFruitNum = reverseLevelUp ? 6 : 0; // 生成随机水果最小值（0-10）0 为葡萄，9 为半个卷王
const maxRandomFruitNum = reverseLevelUp ? 11 : 5; // 生成随机水果最大值（1-11）0 为葡萄，9 为半个卷王
let setFruits = {
  // 指定前几次生成的水果，可填入任意数量的数字，0 为葡萄，9 为半个卷王
...
// 修改网页标题：将 "合成大卷王" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成大卷王';
